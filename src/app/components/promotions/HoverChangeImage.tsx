...
return (
   	<div className="relative flex flex-col items-center cursor-pointer overflow-hidden group/image_item bg-white h-full">
		{
			discountedPrice > 0 && (
				<div className="absolute top-2 left-2 bg-amber-200 text-black text-xs py-0.5 px-4 z-20" style={discountLabelStyle}>
					-{discountPercentage}%
				</div>
			)
		}
		...
		<div className="absolute top-1 right-4 z-10 rounded-full w-8 h-8
